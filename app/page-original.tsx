                    ...
                    <div className="text-center space-y-4">
                        <div className="flex items-center justify-center gap-3 mb-4">
                            ...
                            <div className="text-left">
                                <h1 className="text-4xl md:text-5xl font-bold text-slate-900">Agile Energy
                                    Dashboard</h1>
                                <p className="text-lg text-slate-600 font-medium">Real-time electricity pricing
                                    insights</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
                        <CardHeader>
                            ...
                            <CardDescription className="text-base text-slate-700">
                                Half-hourly electricity prices for the
                                past {validDays} {validDays === 1 ? "day" : "days"}
                                {hasAnyTomorrowPrices
                                            ...
                                            dayCards.push(
                                                ...
                                                >
                                                    <CardHeader
                                                        ...
                                                        <CardDescription className="text-base text-slate-700">
                                                            {dayStats.count} price periods •
                                                            Avg: {dayStats.avg.toFixed(2)}p/kWh
                                                        </CardDescription>
                                                    </CardHeader>
                                                ...
                                                >
                                                    ...
                                                    <CardContent
                                                        ...
                                                        <p className="text-slate-700 text-center max-w-sm">
                                                            Typically published after 4 PM. <br/> Please check back
                                                            later.
                                                        </p>
                                                    </CardContent>
                                                </Card>,
